...
- Guide arrivals down to the runway: descend them, vector or let them route to
  the Initial Approach Fix (IAF), clear them to land, give them the wind, and
  hand them off to Tower before touchdown.
